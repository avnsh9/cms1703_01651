...
void Cms1703::initialize() {
  setAnalysisName("cms1703");          
  setInformation(""
    "# search for dark matter\n"
  "");
  setLuminosity(12.9*units::INVFB);      
  bookSignalRegions("J1;J2;J3;J4;J5;J6;J7;J8;J9;J10;J11;J12;J13;J14;J15;J16;J17;J18;J19;J20;J21;J22;V1;V2;V3;V4;V5;V6;V7");
...
void Cms1703::analyze() {
  ...
  if (true_particles.size() > 0)
  {
    for (int i = 0; i < true_particles.size(); i++)
    {
      if (true_particles[i]->Status == 1 && true_particles[i]->PID !=5000521 && true_particles[i]->PID != 5000001 && true_particles[i]->PID != 5000511 && true_particles[i]->PID != 5000512)
      {
  ...
  ///// Use these for dimuon control region
  ...
  else
  {
    ...
    if (missingET->PT > 200.0 && missingET->PT < 230.0)
      countSignalEvent("J1");
