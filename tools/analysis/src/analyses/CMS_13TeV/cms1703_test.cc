...
void Cms1703_test::analyze()
{
  ...
  // cout << muons_pt << " " << hadronic_recoil << endl;
  ...
  if (pruned_leading && pruned_subjettiness && AK8_mass && AK8_charged_constituents && hadronic_recoil > 250.0)
  {
    if (hadronic_recoil > 250.0 && hadronic_recoil < 300.0)
      countSignalEvent("MONOV250_300");

    if (hadronic_recoil > 300.0 && hadronic_recoil < 350.0)
      countSignalEvent("MONOV300_350");

    if (hadronic_recoil > 350.0 && hadronic_recoil < 400.0)
      countSignalEvent("MONOV350_400");

    if (hadronic_recoil > 400.0 && hadronic_recoil < 500.0)
      countSignalEvent("MONOV400_500");

    if (hadronic_recoil > 500.0 && hadronic_recoil < 600.0)
      countSignalEvent("MONOV500_600");

    if (hadronic_recoil > 600.0 && hadronic_recoil < 750.0)
      countSignalEvent("MONOV600_750");

    if (hadronic_recoil > 750.0)
  ...
  else
  {
    ...
    ///////////////////////////////
    ////////////////////////////////
    if (hadronic_recoil > 200.0 && hadronic_recoil < 230.0)
      countSignalEvent("MONOJ200_230");
    if (hadronic_recoil > 230.0 && hadronic_recoil < 260.0)
      countSignalEvent("MONOJ230_260");
    if (hadronic_recoil > 260.0 && hadronic_recoil < 290.0)
      countSignalEvent("MONOJ260_290");
    if (hadronic_recoil > 290.0 && hadronic_recoil < 320.0)
      countSignalEvent("MONOJ290_320");
    if (hadronic_recoil > 320.0 && hadronic_recoil < 350.0)
      countSignalEvent("MONOJ320_350");
    if (hadronic_recoil > 350.0 && hadronic_recoil < 390.0)
      countSignalEvent("MONOJ350_390");

    if (hadronic_recoil > 390.0 && hadronic_recoil < 430.0)
      countSignalEvent("MONOJ390_430");

    if (hadronic_recoil > 430.0 && hadronic_recoil < 470.0)
      countSignalEvent("MONOJ430_470");

    if (hadronic_recoil > 470.0 && hadronic_recoil < 510.0)
      countSignalEvent("MONOJ470_510");

    if (hadronic_recoil > 510.0 && hadronic_recoil < 550.0)
      countSignalEvent("MONOJ510_550");

    if (hadronic_recoil < 590.0 && hadronic_recoil > 550.0)
      countSignalEvent("MONOJ550_590");

    if (hadronic_recoil < 640.0 && hadronic_recoil > 590.0)
      countSignalEvent("MONOJ590_640");

    if (hadronic_recoil < 690.0 && hadronic_recoil > 640.0)
      countSignalEvent("MONOJ640_690");

    if (hadronic_recoil < 740.0 && hadronic_recoil > 690.0)
      countSignalEvent("MONOJ690_740");

    if (hadronic_recoil < 790.0 && hadronic_recoil > 740.0)
      countSignalEvent("MONOJ740_790");

    if (hadronic_recoil < 840.0 && hadronic_recoil > 790.0)
      countSignalEvent("MONOJ790_840");

    if (hadronic_recoil < 900.0 && hadronic_recoil > 840.0)
      countSignalEvent("MONOJ840_900");

    if (hadronic_recoil < 960.0 && hadronic_recoil > 900.0)
      countSignalEvent("MONOJ900_960");

    if (hadronic_recoil > 960.0 && hadronic_recoil < 1020.0)
      countSignalEvent("MONOJ960_1020");

    if (hadronic_recoil < 1090.0 && hadronic_recoil > 1020.0)
      countSignalEvent("MONOJ1020_1090");

    if (hadronic_recoil > 1090.0 && hadronic_recoil < 1160.0)
      countSignalEvent("MONOJ1090_1160");

    if (hadronic_recoil > 1160.0)
